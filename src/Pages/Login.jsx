                    ...
                    <div className=' max-w-[400px] m-auto mt-[5rem] '>
                        ...
                        <div className='mt-[5rem]'>
                            <div className='border mb-4 border-[#E84025] cursor-pointer hover:border-[#93C234] rounded-md flex items-center'>
                                ...
                                <input type="email" onChange={handleChange} name="email" value={login.email} placeholder='Login Email:' className='focus:outline-none text-[#93C234] w-full rounded-md  h-[45px] ' />
                            </div>
