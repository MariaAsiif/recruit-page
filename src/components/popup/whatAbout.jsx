        ...
        <Modal open={permition} onClose={handleClose} center  >
          <div className='bscontainer-fluid max-h-[500px] p-0 '>
            <div className='row'>
              ...
              <div className='col-lg-6 mt-3 text-justify '>
              ...
              <div className='col-lg-6 mt-6 text-justify '>
                <h2 className='text-red-500 italic font-medium mb-3 text-left'>
                  About ßeta and General Release Software

                </h2>
                <span className='text-[9px]'>A General Release Candidate (GA) In the software release life cycle, general availability (GA) refers to the marketing phase when all commercialization activities pertaining to the software product have been completed, and it is available for purchase.
                  A Release Candidate (RC) is a pre-release version of the software that is being prepared for its final product release (in the RC phase) to the public. This is sometimes referred to as 
                  <br/>
                  <br/>
