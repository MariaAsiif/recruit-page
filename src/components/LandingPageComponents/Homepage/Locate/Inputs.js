    ...
    <>
      ...
      <div className='bscontainer-fluid mb-4 input_Select'>
        <div className='row'>
          ...
          <div className='col-lg-2'>
            <select  className=' select_op text-sm flex items-center  p-5' name="state" value={locationModel.state} onChange={handleChangeCountryStateCity}  >
          ...
          <div className='col-lg-2'>
            <select  className=' select_op text-sm flex items-center  p-5' name="city" value={locationModel.city} onChange={handleChangeCountryStateCity}  >
          ...
          <div className='col-lg-2'>
            <select  className=' select_op text-sm flex items-center  p-5' name="services" value={locationModel.services} onChange={handleChangeCountryStateCity}>
          ...
          <div className='col-lg-1'>
            <select  className=' select_op text-sm flex items-center  p-5' name="minDistances" value={locationModel.minDistances} onChange={handleChangeCountryStateCity}>
          ...
          <div className='col-lg-1'>
            <select  className=' select_op text-sm flex items-center  p-5' name="maxDistances" value={locationModel.maxDistances} onChange={handleChangeCountryStateCity}>
