          ...
          <div className="list_data mt-3">
            <ul className="lg:flex items-center justify-between cursor-pointer" >
              {manus.map((manu, index) => (
                <li className='lg:w-full flex items-center justify-center border first:ml-0 ml-1 text-[18px] p-2 bg-[#DC3545] text-white rounded-md' onClick={() => handleIndex(index)}>
                  {manu}
                  {active === index ?
