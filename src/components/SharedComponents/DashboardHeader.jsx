                ...
                <div className="flex items-center justify-between h-16 -mb-px">
                    ...
                    <div className="lg:w-[100%] ">
                        <div className='flex justify-between items-center top_search_bar '>
                            <div className='flex search_bar pt-1 w-[45%]'>
                                <input onClick={() => Toggle(true)} className='bg-[#F3F6FB]  w-[500px] focus:outline-none  md:w-[100%] py-1 px-2 text-xs text-[#999FA9]' placeholder='search' />
                                <button className='bg-green-700 h-[45px] rounded-sm lg:w-[8%] ml-2'><BiSearch className='inline text-white' /></button>
                            </div>
                            <div className='  search_bar_items'>
                                <div className={checkExpand ? "flex items-cente text-[10px]" : 'flex items-center '}>
