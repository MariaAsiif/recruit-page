            ...
            <div className="px-4 sm:px-6 lg:px-6">
                <div className="flex items-center justify-between h-16 -mb-px">
                    ...
                    <div className="lg:w-[100%] ">
                        <div className='row top_search_bar '>
                            <div className='col-lg-6 col-12 flex search_bar'>
                                <input className='bg-[#F3F6FB] h-auto focus:outline-none lg:w-[100%] md:w-[100%] py-1 px-2 text-xs text-[#999FA9]' placeholder='search' />
                                <button className='bg-[#E84025] rounded-sm lg:w-[8%] ml-2'><BiSearch className='inline text-white' /></button>
                            </div>
                            <div className='col-lg-6 col-12  search_bar_items'>
                                <div className={checkExpand ? "flex items-cente text-[10px]" : 'flex items-cente '}>
                                    ...
                                    <div className='lg:flex lg:items-center  p-2 hidden'>
