            ...
            <div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
                ...
                <div className="flex items-center relative">
                    ...
                    <div className="dropdown relative">
                        ...
                        <ul className=" dropdown-menu min-w-max absolute hiddenbg-white text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none left-auto right-0" aria-labelledby="dropdownMenuButton1">
                            <li>
