        ...
        <>
            <div className='col-lg-12 text-center pt-14'>
                ...
                <div className='text-[#626973] fonst-sans font-medium mb-20'>
                    ...
                    <input value="321 5432190" className='border-b border-[#d4d5d6] focus:outline-none px-2 py-1 mr-2  w-56' />
                ...
                <div className='text-[#626973] fonst-sans font-medium mb-20'>
                    ...
                    <input value="testingemail@email.com" className='border-b border-[#d4d5d6] focus:outline-none px-2 py-1 mr-2  w-56' />
                    <BsCheckCircleFill size={20} className='inline' />
                </div>
            </div>
        </>
