...
const ConsultationType = ({ handleNext, handleBack }) => {
    var today = new Date();
              ...
              <h2 className='font-semibold text-slate-800'>Add new Inspire</h2>
                    ...
                    <div className='col-lg-4 mb-4 relative'>
                        ...
                        <select
                            className={`border p-[10px] focus:outline-blue-500 rounded-sm w-full -mt-[1px]  `}
                        >
                            <option>Select communication</option>
                            <option>Admin</option>
                            <option>Super Admin</option>
                            <option>Hr</option>
                        </select>
                    ...
                    <div className='col-lg-12 flex justify-between'>
                        ...
                        <button onClick={(e) => handleNext(e)} className='p-2 bg-red-500 hover:bg-green-600 text-white'>Next</button>
                    </div>
                </div>
            </form>
        </div>
