...
const Terms = ({ toggle, prev }) => {
    return (
        <div className={`terms text-black  ${prev === false && 'hover:bg-[#e84025] text-white  cursor-pointer' }  cursor-pointer ] `}>
            
            <footer className={` ${prev === false && ' bscontainer  d-flex  text-xs text-center font-normal py-3 footer'} bscontainer  d-flex  text-xs text-center font-normal py-3 footer `}>
