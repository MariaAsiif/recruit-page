                ...
                <div className="space-y-8">
                    <div>
                        <ul className="mt-3 h-[550px] overflow-y-auto ">
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/orders" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/notifications" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/support" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/invoice" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/orderdetails" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
                            ...
                            <li className={`mb-3 last:mb-0  ${pathname === "/newdashboard/invoiceinfo" ? "bg-white" : ""} group  hover:bg-white transition duration-150 `}>
                                <div className='flex '>
