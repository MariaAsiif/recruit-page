...
function ProfileDropdown() {
  ...
  return (
    <div className="relative">
      <button
        ref={trigger}
        className={`p-2 w-[160px] text-[14px] flex items-center ${ dropdownOpen  ?  "bg-white shadow border rounded-sm" : ""}  justify-between  bg-white border-slate-200 hover:border-slate-300 text-slate-500 hover:text-slate-600`}
