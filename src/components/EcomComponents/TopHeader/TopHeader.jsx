...
const TopHeader = () => {
    ...
    return (
        <>
            <div className='bg-[#707070] lg:h-[40px] lg:p-0 pb-2 hidden lg:block '>
                            ...
                            <ul className='flex items-center h-full'>
                                <li className=' border-r border-gray-400  px-2 h-[40px] pt-[10px]'>
                                    <div className='flex items-center'>
                                        ...
                                        <h2 className='text-[14px] text-white px-1'>+203-333-422-3333</h2>
                                    </div>
                                </li>
                                <li>
                                    <div className='flex items-center pl-2'>
                                        <HiOutlineMailOpen className="text-white" />
                                        <h2 className='text-[14px] text-white px-1'>info@helpdesk.com</h2>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-8">
                            <div className='flex justify-end'>
                                <ul className='flex items-center '>
                                    ...
                                    <li className='border-r border-gray-400  px-2'>
                                    ...
                                    <li className=' px-2 '>
                                        <h2 className='text-[14px] text-white px-1'>Register / Login</h2>
                                    </li>
                                </ul>
                            </div>
                        </div>
