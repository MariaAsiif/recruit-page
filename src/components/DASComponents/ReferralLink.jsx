            ...
            <div style={{ boxShadow: "0px 3px 6px #00000029" }} className="border border-[#70707045]  pt-4 pb-1 lg:px-6 px-6 rounded-md font-sans">
                ...
                <div className='justify-center row g-0'>
                    ...
                    <div className='mb-3 text-center col-lg-7'>
                        <button onClick={() => props.onNext("ProviderInformation")} className='font-sans font-medium text-lg border-2 border-[#4DA676] rounded px-16 py-1 text-[#4DA676] hover:text-white hover:bg-[#4DA676] transition-all'>Next <IoChevronForward className='inline' /></button>
